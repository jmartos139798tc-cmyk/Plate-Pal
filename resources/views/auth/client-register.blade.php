...
<div class="flex min-h-screen font-sans">
    ...
    <div class="w-full lg:w-1/2 flex flex-col px-8 lg:px-20 py-10 bg-white overflow-y-auto">
        ...
        <div class="flex-1 flex flex-col justify-center max-w-md mx-auto w-full pb-10">
            ...
            <p class="text-gray-500 text-lg mb-8">Join PlatePal to discover and book local caterers</p>
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-5">
                ...
                {{-- Full Name --}}
                <div>
                    <label class="block text-base font-semibold text-gray-900 mb-2">Full Name</label>
                    <input type="text" name="name" required placeholder="Juan Dela Cruz"
                        class="w-full px-4 py-3.5 rounded-xl bg-gray-50 border border-gray-200 text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#f44e08] transition-all">
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input id="password" type="password" name="password" required placeholder="Create a strong password"
                            class="w-full px-4 py-3.5 rounded-xl bg-gray-50 border border-gray-200 text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#f44e08] transition-all pr-12">
    ...
    <div class="hidden lg:flex lg:w-1/2 bg-[#f44e08] flex-col justify-center px-20 text-white">
        <div class="max-w-lg">
            <h2 class="text-5xl font-bold leading-tight mb-6">Welcome to PlatePal</h2>
            ...
            <ul class="space-y-6">
                ...
                <li class="flex items-center gap-4">
                    <div class="bg-white/20 rounded-full p-1">
                        <svg class="size-5 text-white" fill="none" stroke="currentColor" stroke-width="3" viewBox="0 0 24 24">
